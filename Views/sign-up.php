...
<body class="signup text-center"><!--text-center=Bootstrapのクラスでテキストを中央寄せにする-->
    <main class="form-signup">
        <form action="sign-up.php" method="post"><!--同ページ内にデータをPOSTする-->
            <img src="<?php echo HOME_URL; ?>Views//img/logo-white.svg" alt="" class="logo-white">
            <h1>アカウントを作る</h1><!--placeholder=背景文字、required=必須項目、autofocus=ページ表示の際に自動で選択されているように-->
            ...
            <button class="w-100 btn btn-lg" type="submit">登録する</button><!--w-100=widthが100、lg=大きなボタン-->
